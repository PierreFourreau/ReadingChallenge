...
public class ProgressActivity extends BaseActivity {
  ...
  public void getCategories() {
    ...
    List<Category> categories = ((ReadingChallengeApplication) this.getApplication()).getCategories();
  ...
  public void calculateNumberOfReadCategories(List<Category> categories) {
    ...
    progressLine.setText(getString(R.string.progress_number_label1)
        + " "
        + numberReadCategories
        + " "
        + getString(R.string.progress_number_label2)
        + " "
        + totalCategories);
    ...
    //beginner
      ...
      } else if (numberReadCategories <= 11) progressCommentTextView.setText(getString(R.string.progress_comment50));
    }
    //intermediate
      ...
      if (numberReadCategories < 4) {
        ...
        progressCommentTextView.setText(getString(R.string.progress_comment40));
      } else if (numberReadCategories <= 23) progressCommentTextView.setText(getString(R.string.progress_comment50));
    }
    //expert
      ...
      if (numberReadCategories < 10) {
        ...
        progressCommentTextView.setText(getString(R.string.progress_comment40));
      } else if (numberReadCategories <= 51) progressCommentTextView.setText(getString(R.string.progress_comment50));
    }
  ...
  @Override public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (id) {
      ...
      case R.id.action_share:
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.action_share_progress1)
            + " "
            + numberReadCategories
            + " "
            + getString(R.string.action_share_progress2)
            + " "
            + totalCategories
            + " "
            + getString(R.string.action_share_progress3)
            + " "
            + hashtag);
